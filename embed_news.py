...
class NewsEmbeddingPipeline:
    """
    News Domain Embedding Pipeline for RAG System
    ...
    def load_data(self) -> None:
        """Load all news domain data files"""
        ...
        # Load labels for metadata enrichment
    ...
    def process_rns_announcements(self) -> List[Dict[str, Any]]:
        ...
        print(f"Created {len(processed_records)} RNS chunks")
    ...
    def process_enhanced_news(self) -> List[Dict[str, Any]]:
        ...
        print(f"Created {len(processed_records)} enhanced news chunks")
        return processed_records
